...
//                                                            └─────────────────┴───────────────┴─────────┴───────────────┴────────────────┴───────────────┘
[_COLEMAK] = LAYOUT(
  KC_0            , KC_1              , KC_2         , KC_3         , KC_4               , KC_5             ,                              KC_6              , KC_7             , KC_8         , KC_9           , DF(_GAMING)          , MO(_BUTTON),
  ...
  LCTL_T(KC_CAPS) , KC_Z               , ALGR_T(KC_X) , KC_C         , KC_D               , KC_V             , KC_NO   , KC_NO            , KC_K              , KC_H             , KC_COMM      , ALGR_T(KC_DOT) , KC_SLSH               , KC_CAPS,
...
//                                                    └─────────────────┴───────────────┴─────────┴───────────────┴────────────────┴───────────────┘
[_EXTRA] = LAYOUT(
  KC_0    , KC_1              , KC_2         , KC_3         , KC_4               , KC_5             ,                              KC_6              , KC_7             , KC_8         , KC_9           , KC_NO                , MO(_BUTTON),
  ...
  KC_LCTL , KC_Z               , ALGR_T(KC_X) , KC_C         , KC_V               , KC_B             , KC_NO   , KC_NO            , KC_N              , KC_M             , KC_COMM      , ALGR_T(KC_DOT) , KC_SLSH               , KC_CAPS,
                                                              LT(_MEDIA, KC_ESC) , LT(_NAV, KC_SPC) , CW_TOGG , LT(_SYM, KC_ENT) , LT(_NUM, KC_BSPC) , LT(_FUN, KC_DEL)
),
...
[_TAP] = LAYOUT(
  ...
  KC_LCTL , KC_Z , KC_X , KC_C , KC_V   , KC_B   , KC_NO   , KC_NO  , KC_N              , KC_M             , KC_COMM , KC_DOT , KC_SLSH , KC_CAPS,
...
[_BUTTON] = LAYOUT(
  ...
  KC_LCTL , KC_NO   , KC_CUT  , KC_COPY , KC_PASTE , KC_NO , KC_NO , KC_NO , KC_NO , KC_PASTE , KC_COPY , KC_CUT  , KC_NO   , KC_CAPS,
...
[_NAV] = LAYOUT(
  ...
  KC_LCTL , KC_NO   , KC_ALGR , KC_NO   , KC_NO   , KC_NO , KC_NO , KC_NO  , KC_HOME , KC_PGDN  , KC_PGUP , KC_NO   , KC_NO   , KC_CAPS,
...
[_MEDIA] = LAYOUT(
  ...
  KC_LCTL , KC_NO   , KC_ALGR , KC_NO   , KC_NO   , KC_NO , KC_NO , KC_NO   , KC_NO   , KC_NO   , KC_NO   , KC_NO   , OU_AUTO , KC_CAPS,
...
[_NUM] = LAYOUT(
  ...
  KC_LCTL , KC_GRV  , KC_1 , KC_2 , KC_3   , KC_BSLS , KC_NO   , KC_NO , KC_NO   , KC_NO   , KC_NO   , KC_ALGR , KC_NO   , KC_CAPS,
...
[_SYM] = LAYOUT(
  ...
  KC_LCTL , KC_TILD , KC_EXLM , KC_AT   , KC_HASH , KC_PIPE , KC_NO   , KC_NO , KC_NO , KC_NO   , KC_NO   , KC_ALGR , KC_NO   , KC_CAPS,
...
[_FUN] = LAYOUT(
  ...
  KC_LCTL , KC_F10 , KC_F1 , KC_F2 , KC_F3  , KC_PAUS , QK_BOOT , KC_NO , KC_NO , KC_NO   , KC_NO   , KC_ALGR , KC_NO   , KC_CAPS,
...
static void set_rgb_theme_for_default_layer(layer_state_t state) {
    hsv_t sugar = (hsv_t){212, 56, 255};
    hsv_t theme = get_highest_layer(state) == _GAMING ? (hsv_t){HSV_GREEN} : sugar;

    rgb_matrix_sethsv(theme.h, theme.s, rgb_matrix_get_val());
}

// The Iris Rev. 8 LEDs render red comparatively weakly. When red is present,
// heavily reduce the competing green and blue channels to restore the hue.
...
bool rgb_matrix_indicators_advanced_user(uint8_t led_min, uint8_t led_max) {
    ...
    if (set || gaming_default) {
        // Limit brightness to driver max.
        if (set && hsv.v > rgb_matrix_get_val()) {
            hsv.v = rgb_matrix_get_val();
        }
        rgb_t converted = set ? compensate_red_weakness(hsv_to_rgb(hsv)) : (rgb_t){0, 0, 0};
        rgb_t gaming    = hsv_to_rgb((hsv_t){HSV_GREEN});
        ...
        for (uint8_t row = 0; row < MATRIX_ROWS; row++) {
            for (uint8_t col = 0; col < MATRIX_COLS; col++) {
                ...
                if (gaming_default && is_thumb_position(row, col)) {
                    rgb_matrix_set_color(index, gaming.r, gaming.g, gaming.b);
                    continue;
                }
                ...
                if (show_layer && keymap_key_to_keycode(layer, (keypos_t){.row = row, .col = col}) <= KC_TRNS) {
                    continue;
                }
...
layer_state_t default_layer_state_set_user(layer_state_t state) {
    ...
    if (previous_state != 0 && state != previous_state) {
        caps_word_off();
        if (host_keyboard_led_state().caps_lock) {
            tap_code(KC_CAPS);
        }
    ...
    set_rgb_theme_for_default_layer(state);
    return state;
}
...
void keyboard_post_init_user(void) {
    ...
    set_rgb_theme_for_default_layer(default_layer_state);
}
